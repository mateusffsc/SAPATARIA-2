...
interface ServiceCostCompositionProps {
  serviceId: string;
  initialCost?: ServiceCostData;
  onCostChange: (cost: ServiceCostData) => void;
  disabled?: boolean;
}
...
const ServiceCostComposition: React.FC<ServiceCostCompositionProps> = ({
  ...
  useEffect(() => {
    ...
    const updatedCostData = { ...costData, finalPrice };
    setCostData(updatedCostData);
    onCostChange(updatedCostData);
  }, [
    costData.laborCost,
  ...
  return (
    <div className="space-y-6 bg-gray-50 p-6 rounded-lg">
      <div className="flex items-center space-x-2">
        ...
        <h3 className="text-lg font-semibold text-gray-900">Composição de Custo</h3>
      </div>
